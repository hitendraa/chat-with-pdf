...
const features = [
  ...
  },
  {
    ...
    description: "Our intelligent Chatbot remembers previous conversations, providing a seamless experience.",
    icon: BrainCogIcon,
  },
  {
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <span className="font-bold">dynamic conversations</span>, enhancing productivity tenfold effortlessly.
            </p>
          </div>
